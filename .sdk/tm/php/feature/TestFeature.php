...
// Vercel SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class VercelTestFeature extends VercelBaseFeature
{
    ...
    public function init(VercelContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (VercelContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (VercelContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(VercelContext $ctx, $op, $args): array
    {
