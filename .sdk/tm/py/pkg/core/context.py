...
from projectname_sdk.core.control import VercelControl
...
class VercelContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, VercelResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return VercelError(code, msg, self)
