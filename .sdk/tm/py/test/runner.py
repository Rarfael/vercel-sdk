...
class VercelTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = VercelTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = VercelTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = VercelTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
