...
from projectname_sdk import VercelSDK
from projectname_sdk.core.spec import VercelSpec
from projectname_sdk.core.result import VercelResult
from projectname_sdk.core.response import VercelResponse
from projectname_sdk.core.operation import VercelOperation
from projectname_sdk.core.error import VercelError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import VercelBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = VercelSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = VercelSDK.test(None, None)
        ...
        class TestInitFeature(VercelBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(VercelBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = VercelSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = VercelSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = VercelSDK.test(None, setup_opts)
