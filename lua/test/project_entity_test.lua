...
describe("ProjectEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set VERCEL_TEST_PROJECT_ENTID JSON to run live")
      return
    end
    ...
    local project_ref01_markdef_up0_name = "accountId"
...
function project_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("VERCEL_TEST_PROJECT_ENTID")
