...
// Vercel SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (VercelSDK::test)
...
{
    private const SDK_CLASS = 'VercelSDK';
    ...
    private const SDK_BASE = 'vercel_sdk';
