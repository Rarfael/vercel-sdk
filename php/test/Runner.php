...
class VercelTestRunner
{
    ...
    {
        $live = self::getenv('VERCEL_TEST_LIVE');
        $override = self::getenv('VERCEL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('VERCEL_TEST_EXPLAIN');
...
class_alias('VercelTestRunner', 'Runner');
class_alias('VercelHelpers', 'Helpers');
