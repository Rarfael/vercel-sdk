...
class VercelFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; VercelSDK/1.0)';
    ...
    public static function call(VercelContext $ctx, string $fullurl, array $fetchdef): array
    {
