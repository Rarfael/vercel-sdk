...
// Vercel SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class VercelMakeRequest
{
    public static function call(VercelContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new VercelResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new VercelResponse($fetched);
        } else {
