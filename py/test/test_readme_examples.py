# Vercel SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions VercelSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both VercelSDK(...) and VercelSDK.test(...) become
#      VercelSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "vercel_sdk"
_SDK_CLASS = "VercelSDK"
